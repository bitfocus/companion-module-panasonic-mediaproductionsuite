...
export function getFramingStatusText(status) {
    switch (status) {
        case 0:
            return 'Stopped';
        case 1:
...
export function getFramingEnableText(enable) {
    switch (enable) {
        case 0:
            return 'Off';
        case 1:
...
export function updateVariablesFromState(cameraId, state) {
    const values = {};
...
export function getAngleModeText(angle) {
    switch (angle) {
        case 0:
            return 'Upper';
        case 1:
...
export function updateVariablesFromAutoTracking(cameraId, state) {
    const values = {};
...
export function updateVideoMixerVariables(pgmCell, layout, enabled, volume) {
    const values = {
        vm_pgm_cell: pgmCell,
        vm_layout: layout,
...
export function updateLicenseVariables(licenseData) {
    const values = {};
